...
# Save the data
```{r}
saveRDS(albums, "/Data/RDS Files/albums.rmd")
saveRDS(artist, "/Data/RDS Files/artist.rmd")
saveRDS(tracks, "/Data/RDS Files/tracks.rmd")
```
